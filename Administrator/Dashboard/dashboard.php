               ...
               if (!empty($rows)) {
                  foreach ($rows as $row) {
                     ...
                     <tr>
                        ...
                        ?>>
                           <a id="status" href="../Commands/update.php?id=<?php echo $row['id']; ?>">
                              <?php echo $row['status']; ?>
                           </a>
                        </td>
                        <td>
                           <a href="../Commands/show_files.php?id=<?php echo $row['file']; ?>">
                              <?php echo $row['file']; ?>
                           </a>
                        </td>
                        <td>
                           <a href="../Commands/delete.php?id=<?php echo $row['id'];
                           echo $row['file']; ?>"
